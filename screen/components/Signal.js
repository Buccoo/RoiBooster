...
export default function renderSignal() {
  const [pressed, setPressed] = useState(false);
  return (
    <View style={styles.container}>
      {!pressed
        ? SignalNotPressed(pressed, setPressed)
        : SignalPressed(pressed, setPressed)}
    </View>
  );
}

const SignalPressed = (pressed, setPressed) => {
  return (
    <TouchableOpacity
...
const SignalNotPressed = (pressed, setPressed) => {
  return (
    <TouchableOpacity
      style={styles.mainCardViewNotPressed}
      onPress={() => setPressed(!pressed)}
    >
      <View style={styles.simbolo}>
        <Text
